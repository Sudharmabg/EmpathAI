...
import com.empathai.intervention.repository.InterventionRepository;
...
import com.empathai.intervention.entity.Intervention;
...
public class AnalyticsService {
    ...
    private final com.empathai.chat.repository.FlaggedChatRepository flaggedChatRepository;
    ...
    public AnalyticsDashboardResponse getDashboard(Long studentId, LocalDate weekStart) {
        ...
        long openFlaggedChats = flaggedChatRepository.countByStatus(com.empathai.chat.entity.FlagStatus.PENDING);
