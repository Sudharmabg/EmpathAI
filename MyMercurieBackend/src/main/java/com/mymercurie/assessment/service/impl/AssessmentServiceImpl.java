package com.mymercurie.assessment.service.impl;

import com.mymercurie.assessment.dto.*;
import com.mymercurie.assessment.entity.*;
import com.mymercurie.assessment.repository.*;
...
public class AssessmentServiceImpl implements IAssessmentService {
    ...
    private final com.mymercurie.assessment.service.AnswerOptionService answerOptionService;
    private final com.mymercurie.user.repository.SchoolRepository schoolRepo;
    ...
    public GroupResponse createGroup(GroupRequest request) {
        if (groupRepo.existsByName(request.getName())) {
            throw new MyMercurieException("Group '" + request.getName() + "' already exists", "DUPLICATE_GROUP");
        }
    ...
    public void deleteGroup(Long id) {
        if (!groupRepo.existsById(id))
            throw new MyMercurieException("Group not found", "NOT_FOUND");
    ...
    public QuestionResponse updateQuestion(Long id, QuestionRequest request) {
        AssessmentQuestion q = questionRepo.findById(id)
                .orElseThrow(() -> new MyMercurieException("Question not found", "NOT_FOUND"));
    ...
    public void deleteQuestion(Long id) {
        if (!questionRepo.existsById(id))
            throw new MyMercurieException("Question not found", "NOT_FOUND");
        ...
        if (r.getStudent() != null) {
            ...
            if (r.getStudent().getSchoolId() != null) {
                schoolName = schoolRepo.findById(r.getStudent().getSchoolId())
                        .map(com.mymercurie.user.entity.School::getName)
                        .orElse("");
            }
        }
