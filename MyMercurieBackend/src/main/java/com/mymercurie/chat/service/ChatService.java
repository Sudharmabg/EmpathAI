...
import com.mymercurie.assessment.repository.AssessmentReportRepository;
import com.mymercurie.chat.dto.*;
import com.mymercurie.chat.entity.ChatMessage;
import com.mymercurie.chat.entity.ChatSession;
...
import com.mymercurie.chat.repository.ChatUsageRepository;
...
public class ChatService {
    ...
    public ChatMessageResponse sendMessage(
        ...
        User user = userRepository.findById(studentId)
                .orElseThrow(() -> new MyMercurieException("Student not found"));
            ...
            aiResponse = this.webClient
                    ...
                    .onStatus(
                            ...
                            response -> response.bodyToMono(String.class)
                                    .map(body -> new MyMercurieException("AI service error: " + body))
                    )
        ...
        if (aiResponse == null) {
            ...
            throw new MyMercurieException("Received empty response from AI service");
        }
    ...
    public void logScheduleMessage(
        ...
        try {
            ...
            session = sessionRepo
                    .findByStudentIdAndWeekStartAndSource(studentId, weekStart, "SCHEDULE")
                    .orElseThrow(() -> new MyMercurieException("Could not find or create session"));
        }
    ...
    public ChatSessionResponse getSessionMessages(Long sessionId, Long studentId) {
        ChatSession session = sessionRepo.findById(sessionId)
                .orElseThrow(() -> new MyMercurieException("Session not found"));

        if (!session.getStudentId().equals(studentId))
            throw new MyMercurieException("Access denied");
