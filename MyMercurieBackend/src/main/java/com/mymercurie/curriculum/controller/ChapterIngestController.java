package com.mymercurie.curriculum.controller;
...
import com.mymercurie.curriculum.service.ChapterIngestService;
...
public class ChapterIngestController {
    ...
    public ResponseEntity<byte[]> getImage(@PathVariable Long imageId) {
        com.mymercurie.curriculum.entity.ChapterImage image = chapterIngestService.getChapterImage(imageId);
