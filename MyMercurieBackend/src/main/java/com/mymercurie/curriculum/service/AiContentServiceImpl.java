...
import com.mymercurie.curriculum.dto.request.*;
import com.mymercurie.curriculum.dto.response.*;
import com.mymercurie.curriculum.entity.AiGeneratedContent;
import com.mymercurie.curriculum.entity.AiTaskType;
import com.mymercurie.curriculum.entity.ApprovalStatus;
import com.mymercurie.curriculum.repository.AiGeneratedContentRepository;
...
public class AiContentServiceImpl implements AiContentService {
    ...
    public AiProcessResponse process(AiProcessRequest request) {
        ...
        try {
            pythonResponse = webClientBuilder.build()
                ...
                .onStatus(HttpStatusCode::is5xxServerError, resp ->
                    resp.bodyToMono(String.class)
                        .map(body -> new MyMercurieException("AI service error: " + body, HttpStatus.BAD_GATEWAY))
                )
            ...
            throw new MyMercurieException("AI generation temporarily unavailable. Please try again.", HttpStatus.SERVICE_UNAVAILABLE);
        }
        ...
        try {
            ...
            throw new MyMercurieException("Failed to serialize AI response", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public AiProcessResponse getCached(String taskTypeStr, Long chapterId, String topic) {
        ...
        throw new MyMercurieException("Cached content not found or not approved", HttpStatus.NOT_FOUND);
    }
    ...
    public AiProcessResponse generateToolContent(AiGenerateRequest request, String createdBy) {
        ...
        com.mymercurie.curriculum.entity.Chapter chapter = chapterRepository.findById(request.getChapterId())
            .orElseThrow(() -> new MyMercurieException("Chapter not found", HttpStatus.NOT_FOUND));
    ...
    public AiProcessResponse regenerateToolContent(Long id, String regeneratedBy) {
        AiGeneratedContent existing = contentRepository.findById(id)
            .orElseThrow(() -> new MyMercurieException("Content not found", HttpStatus.NOT_FOUND));

        com.mymercurie.curriculum.entity.Chapter chapter = chapterRepository.findById(existing.getChapterId())
            .orElseThrow(() -> new MyMercurieException("Chapter not found", HttpStatus.NOT_FOUND));
        ...
        try {
            ...
            throw new MyMercurieException("AI generation temporarily unavailable.", HttpStatus.SERVICE_UNAVAILABLE);
        }
