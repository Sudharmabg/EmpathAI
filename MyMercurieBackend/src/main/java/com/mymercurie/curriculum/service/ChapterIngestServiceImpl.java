...
import com.mymercurie.curriculum.entity.Chapter;
import com.mymercurie.curriculum.entity.ProcessingStatus;
import com.mymercurie.curriculum.entity.ChapterTopic;
import com.mymercurie.curriculum.repository.ChapterRepository;
import com.mymercurie.curriculum.repository.ChapterTopicRepository;
import com.mymercurie.curriculum.dto.request.ChapterTopicRequest;
import com.mymercurie.curriculum.dto.response.ChapterTopicResponse;
import com.mymercurie.curriculum.exception.MyMercurieException;
...
public class ChapterIngestServiceImpl implements ChapterIngestService {
    ...
    private final com.mymercurie.curriculum.repository.ChapterImageRepository chapterImageRepository;
    ...
    @Value("${chatbot.ai-service.api-key:mymercurie-internal-key-2026}")
    ...
    public ChapterResponse updateMetadata(Long chapterId, ChapterMetadataUpdateRequest request) {
        ...
        try {
            ...
            throw new MyMercurieException("Failed to update metadata", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    private Chapter getChapterEntity(Long chapterId) {
        return chapterRepository.findById(chapterId)
            .orElseThrow(() -> new MyMercurieException("Chapter not found: " + chapterId, HttpStatus.NOT_FOUND));
    }
    ...
    public ChapterResponse restoreChapter(Long chapterId) {
        ...
        if (chapter.getProcessingStatus() != ProcessingStatus.ARCHIVED) {
            throw new MyMercurieException("Chapter is not archived", HttpStatus.BAD_REQUEST);
        }
    ...
    public ChapterTopicResponse updateTopic(Long topicId, ChapterTopicRequest request) {
        ChapterTopic topic = chapterTopicRepository.findById(topicId)
            .orElseThrow(() -> new MyMercurieException("Topic not found", HttpStatus.NOT_FOUND));
    ...
    public Map<String, String> uploadChapterImage(Long chapterId, String conceptName, org.springframework.web.multipart.MultipartFile file) {
        try {
            com.mymercurie.curriculum.entity.ChapterImage image = com.mymercurie.curriculum.entity.ChapterImage.builder()
                .chapterId(chapterId)
            ...
            throw new MyMercurieException("Failed to read image file", HttpStatus.UNPROCESSABLE_ENTITY, ex);
        }
    }

    @Override
    public com.mymercurie.curriculum.entity.ChapterImage getChapterImage(Long imageId) {
        return chapterImageRepository.findById(imageId)
            .orElseThrow(() -> new MyMercurieException("Image not found", HttpStatus.NOT_FOUND));
    }
}
