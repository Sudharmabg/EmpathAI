...
import com.mymercurie.curriculum.entity.Syllabus;
import com.mymercurie.curriculum.exception.MyMercurieException;
import com.mymercurie.curriculum.repository.ModuleRepository;
import com.mymercurie.curriculum.repository.QuizQuestionRepository;
import com.mymercurie.curriculum.repository.SubTopicRepository;
import com.mymercurie.curriculum.repository.SyllabusRepository;
...
public class CurriculumServiceImpl implements CurriculumService {
    ...
    public void deleteSyllabus(Long id) {
        if (!syllabusRepository.existsById(id))
            throw new MyMercurieException("Syllabus not found with id: " + id, HttpStatus.NOT_FOUND);
    ...
    public void deleteModule(Long id) {
        if (!moduleRepository.existsById(id))
            throw new MyMercurieException("Module not found with id: " + id, HttpStatus.NOT_FOUND);
    ...
    public void deleteSubTopic(Long id) {
        if (!subTopicRepository.existsById(id))
            throw new MyMercurieException("SubTopic not found with id: " + id, HttpStatus.NOT_FOUND);
    ...
    public void deleteQuizQuestion(Long id) {
        if (!quizQuestionRepository.existsById(id))
            throw new MyMercurieException("Quiz question not found with id: " + id, HttpStatus.NOT_FOUND);
