package com.mymercurie.intervention.controller;
...
public class InterventionController {
    ...
    private final com.mymercurie.intervention.service.InterventionService interventionService;
    ...
    public ResponseEntity<com.mymercurie.intervention.dto.InterventionResponse> createIntervention(
            @RequestBody com.mymercurie.intervention.dto.InterventionRequest request) {
    ...
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'PSYCHOLOGIST', 'SCHOOL_ADMIN')")
    public ResponseEntity<java.util.List<com.mymercurie.intervention.dto.InterventionResponse>> getInterventionsByStudentId(
            @PathVariable Long studentId) {
