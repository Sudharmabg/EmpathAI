...
@RestControllerAdvice(basePackages = {"com.mymercurie.user.controller", "com.mymercurie.schedule.controller"})
@Slf4j
public class GlobalExceptionHandler {

    @ExceptionHandler(MyMercurieException.class)
    public ResponseEntity<ApiResponse<Object>> handleMyMercurieException(MyMercurieException ex) {
