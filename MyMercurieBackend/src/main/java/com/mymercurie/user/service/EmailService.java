...
public class EmailService {
    ...
    public void sendPasswordSetupEmail(User user) {
        ...
        CreateEmailOptions params = CreateEmailOptions.builder()
                .from("MyMercurie <onboarding@resend.dev>")// replace with your verified Resend domain
                .to(user.getEmail())
                .subject("Set Up Your MyMercurie Password")
        ...
        return """
            ...
            <body style="font-family: Arial, sans-serif; background: #f4f4f4; padding: 30px;">
              <div style="max-width: 500px; margin: auto; background: white;
                ...
                <h2 style="color: #7c3aed;">Welcome to MyMercurie! 👋</h2>
                ...
                <p style="color: #aaa; font-size: 12px; text-align: center;">
                  MyMercurie — Student Wellness Platform
                </p>
              </div>
            </body>
            </html>
