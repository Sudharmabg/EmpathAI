package com.mymercurie.user.service.impl;
...
import com.mymercurie.user.entity.Teacher;
...
import com.mymercurie.user.repository.TeacherRepository;
import com.mymercurie.user.service.TeacherService;
...
public class TeacherServiceImpl implements TeacherService {
    ...
    public TeacherResponse updateTeacher(Long id, TeacherRequest request) {
        Teacher t = teacherRepository.findById(id)
                .orElseThrow(() -> new MyMercurieException("Teacher not found: " + id));
    ...
    public void deleteTeacher(Long id) {
        if (!teacherRepository.existsById(id))
            throw new MyMercurieException("Teacher not found: " + id);
